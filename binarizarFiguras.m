function [ propiedadesFiguras,imBinFiguras ] = binarizarFiguras( Imagen )
...
imBinFiguras = imfill(imBin,'holes');
...
for  l=1: numObj
    ...
    propiedadesFiguras = cat(2,propiedadesFiguras,datosImagen);
